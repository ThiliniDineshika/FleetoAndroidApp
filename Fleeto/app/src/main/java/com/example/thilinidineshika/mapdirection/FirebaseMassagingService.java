...
public class FirebaseMassagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    private void showNotification(String massage) {
        ...
        NotificationCompat.Builder builder= new NotificationCompat.Builder(this)
                ...
                .setAutoCancel(true)
                .setContentTitle("Fleeto Instant Notification")
                .setContentText(massage+" fleeto sends you this message to test the long strings in the notification bar with a lot of text")
